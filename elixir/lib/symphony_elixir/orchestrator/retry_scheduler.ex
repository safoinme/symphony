defmodule SymphonyElixir.Orchestrator.RetryScheduler do
  @moduledoc """
  Pure-function helpers for scheduling and managing issue retries
  ...
  def pop_retry_attempt_state(state, issue_id, retry_token) when is_reference(retry_token) do
  ...
  @spec retry_delay(pos_integer(), map()) :: non_neg_integer()
  ...
  @spec failure_retry_delay(pos_integer()) :: non_neg_integer()
