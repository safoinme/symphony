defmodule SymphonyElixir.Orchestrator.TokenAccounting do
  @moduledoc """
  Pure-function helpers for tracking token usage and rate limits
  from Codex/Claude Code agent updates.
  """
  ...
  @spec apply_codex_token_delta(map(), map()) :: map()
  ...
  @spec apply_codex_rate_limits(map(), map()) :: map()
  def apply_codex_rate_limits(state, update) when is_map(update) do
  ...
  @spec record_session_completion_totals(map(), map()) :: map()
  ...
  @spec running_seconds(DateTime.t() | nil, DateTime.t()) :: non_neg_integer()
  ...
  defp session_id_for_update(_existing, %{session_id: session_id})
